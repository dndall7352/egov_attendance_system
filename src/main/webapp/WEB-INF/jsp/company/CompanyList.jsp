...
function fn_egov_select(comNumber) {
	document.getElementById("listForm").comNumber.value = comNumber;
   	document.getElementById("listForm").action = "<c:url value='/company/updateCompanyView.do'/>";
   	document.getElementById("listForm").submit();
}

/* 글 등록 화면 function */
function fn_egov_addView() {
   	document.getElementById("listForm").action = "<c:url value='/company/addCompanyView.do'/>";
   	document.getElementById("listForm").submit();		
}
...
function fn_egov_link_page(pageNo){
	...
	document.getElementById("listForm").action = "<c:url value='/company/CompanyList.do'/>";
   	document.getElementById("listForm").submit();
}
