...
<%
 /**
  * @Class Name : CodeRegister.jsp
  * @Description : Code Register 화면
...
<c:set var="registerFlag" value="${empty codeVO.code ? '등록' : '수정'}"/>
...
function fn_egov_selectList() {
   	document.getElementById("detailForm").action = "<c:url value='/code/CodeList.do'/>";
   	document.getElementById("detailForm").submit();		
}

/* 글 삭제 function */
function fn_egov_delete() {
   	document.getElementById("detailForm").action = "<c:url value='/code/deleteCode.do'/>";
   	document.getElementById("detailForm").submit();		
}
...
function fn_egov_save() {	
	...
	/* TODO Validation기능 보완 */
  	...
  	frm.action = "<c:url value="${registerFlag == '등록' ? '/code/addCode.do' : '/code/updateCode.do'}"/>";
    frm.submit();
...
<form:form modelAttribute="codeVO" name="detailForm" id="detailForm" >
<div id="content_pop">
	<!-- 타이틀 -->
	<div id="title">
		<ul>
	...
	<table width="100%" border="1" cellpadding="0" cellspacing="0" >
	   ...
	   <tr>
		...
		<tr>
			<th>CODE_GROUP</th>
			<td>
				<form:input path="codeGroup" cssClass="txt"/>
				&nbsp;<form:errors path="codeGroup" />
			</td>
		</tr>	
		<tr>
			<th>P_CODE</th>
			<td>
				<form:input path="PCode" cssClass="txt"/>
		...
		<tr>
			<th>CODE_NAME</th>
			<td>
				<form:input path="codeName" cssClass="txt"/>
		...
		<tr>
			<th>DETH</th>
			<td>
				<form:input path="deth" cssClass="txt"/>
				&nbsp;<form:errors path="deth" />
			</td>
		</tr>	
	</table>
  </div>
