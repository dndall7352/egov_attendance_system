  ...
  <c:set var="beacon" value="${beaconDTO }"></c:set>
    <table class="table select-beacon-table" style="min-width: 100%; width: 100%;">
        <tr>
            ...
            <td class="table-input" style="width: 35%;"><input type="text" class="table-input-text" name="uuid" maxlength="32" value="${beacon.uuid }"></td>
        </tr>
        <tr>
            <td class="thead">회사명</td>
            <td id="cpn-com-name" style="background-color: #B0C3E6; text-align: left; cursor: default;">${beacon.com_name }</td>
            <td class="thead">Major</td>
            <td class="table-input"><input type="text" class="table-input-text beacon-code" maxlength="5" name="major" value="${beacon.major }"></td>
        </tr>
        <tr>
            <td class="thead">C.P.N</td>
            <td class="table-input" style="background-color: #B0C3E6">
            	<div style="display: flex; justify-content: space-between;">
            		<input type="text" class="table-input-text" readonly="readonly" style="width:80%; justify-content: space-between; background-color: #B0C3E6; cursor: default;" name="com_number" value="${beacon.com_number }">
            ...
            <td class="table-input"><input type="text" class="table-input-text beacon-code" maxlength="5" name="minor" value="${beacon.minor }"></td>
        </tr>
        <tr>
            <td class="thead">설치장소</td>
            <td class="table-input"><input type="text" class="table-input-text" name="emplacement" maxlength="50" value="${beacon.emplacement }"></td>
        ...
        <tr>
            ...
            <td colspan="4" class="table-input" style="vertical-align: middle;"><textarea name="note" maxlength="200">${beacon.note }</textarea></td>
        </tr>
    </table>
